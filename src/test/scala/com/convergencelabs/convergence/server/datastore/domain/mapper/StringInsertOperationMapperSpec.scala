...
import com.convergencelabs.convergence.server.datastore.domain.mapper.StringInsertOperationMapper.{ODocumentToStringInsertOperation, StringInsertOperationToODocument}
