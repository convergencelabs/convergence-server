...
class ModelSnapshotConfigSpec extends AnyWordSpec with Matchers {
  ...
  private val versionBasedConfig = domain.ModelSnapshotConfig(
  ...
  private val disabledConfig = domain.ModelSnapshotConfig(
  ...
  private val timeBasedConfig = domain.ModelSnapshotConfig(
    snapshotsEnabled = true,
