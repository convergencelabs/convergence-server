...
import com.convergencelabs.convergence.server.backend.services.domain.chat.ChatActor.{CommonErrors, SetChatNameRequest, SetChatNameResponse}
...
import com.convergencelabs.convergence.server.model.domain.chat.{ChatNameChangedEvent, ChatState}
