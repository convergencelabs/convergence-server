...
import com.convergencelabs.convergence.server.backend.datastore.convergence.{ConvergenceSchemaDeltaLogStore, ConvergenceSchemaVersionLogStore}
import com.convergencelabs.convergence.server.backend.db.DatabaseProvider

object ConvergenceSchemaManager {
...
private[db] class ConvergenceSchemaManager(databaseProvider: DatabaseProvider) extends SchemaManager(
  ...
  new ConvergenceSchemaStatePersistence(
    ...
    new ConvergenceSchemaVersionLogStore(databaseProvider)
  ),
