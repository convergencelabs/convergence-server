...
object ConvergenceSchemaVersionLogClass extends OrientDbClass {
  val ClassName = "ConvergenceSchemaVersionLog"
  ...
  object Indices {
    val Version = "ConvergenceSchemaVersionsLog.version"
  }
}
