...
package com.convergencelabs.convergence.server.backend.services.domain.jwt

import akka.actor.typed.scaladsl.{AbstractBehavior, ActorContext, Behaviors}
import akka.actor.typed.{ActorRef, Behavior}
import com.convergencelabs.convergence.common.Ok
import com.convergencelabs.convergence.server.backend.datastore.domain.jwt.{CreateOrUpdateJwtAuthKey, JwtAuthKeyStore}
...
object JwtAuthKeyStoreActor {
  ...
  // UpdateJwtAuthKey
  //
  final case class UpdateJwtAuthKeyRequest(key: CreateOrUpdateJwtAuthKey, replyTo: ActorRef[UpdateJwtAuthKeyResponse]) extends Message
  ...
  // CreateJwtAuthKey
  //
  final case class CreateJwtAuthKeyRequest(key: CreateOrUpdateJwtAuthKey, replyTo: ActorRef[CreateJwtAuthKeyResponse]) extends Message
