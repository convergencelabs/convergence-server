...
import com.convergencelabs.convergence.server.datastore.convergence.schema.NamespaceClass.Fields
import com.convergencelabs.convergence.server.datastore.convergence.schema.NamespaceClass.Indices
import com.convergencelabs.convergence.server.db.DatabaseProvider
import com.convergencelabs.convergence.server.domain.Namespace
import com.convergencelabs.convergence.server.domain.NamespaceAndDomains
