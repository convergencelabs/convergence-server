...
class ModelSnapshotStoreSpec
  ...
  val person1ModelMetaData = ModelMetaData(CollectionId, person1Id, 10L, Instant.now(), Instant.now(), true, modelPermissions, 1)
  ...
  val person2ModelMetaData = ModelMetaData(CollectionId, person2Id, 10L, Instant.now(), Instant.now(), true, modelPermissions, 1)
