...
case class ActivityJoinRequest(domain: DomainFqn, activityId: String, sk: SessionKey, state: Map[String, Any], actorRef: ActorRef) extends IncomingActivityMessage
case class ActivityLeave(domain: DomainFqn, activityId: String, sk: SessionKey) extends IncomingActivityMessage

case class ActivitySetState(domain: DomainFqn, activityId: String, sk: SessionKey, state: Map[String, Any]) extends IncomingActivityMessage
...
case class ActivityJoinResponse(state: Map[SessionKey, Map[String, Any]]) extends OutgoingActivityMessage
case class ActivityParticipants(state: Map[SessionKey, Map[String, Any]]) extends OutgoingActivityMessage

case class ActivitySessionJoined(activityId: String, sk: SessionKey, state: Map[String, Any]) extends OutgoingActivityMessage
case class ActivitySessionLeft(activityId: String, sk: SessionKey) extends OutgoingActivityMessage

case class ActivityRemoteStateSet(activityId: String, sk: SessionKey, state: Map[String, Any]) extends OutgoingActivityMessage
